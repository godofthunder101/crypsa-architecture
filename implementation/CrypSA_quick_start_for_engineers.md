...
This document provides a simple guide for engineers who want to build a minimal CrypSA-based system.

It does not attempt to implement the entire architecture.
